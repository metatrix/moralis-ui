...
import contractInfo from "contracts/marketplace.json";
...
export default function Contract() {
  ...
  const contractAddress = useMemo(() => networks[80001].address, [networks]);
  ...
  return (
      <div>
          ...
          <div>
              <div style={{ margin: "auto", display: "flex", gap: "20px", marginTop: "25px", width: "70vw" }}>
                  <Card
                      title={
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                              Your contract: {contractName}
